 ...
 * Description: Enhances the free version of Polylang with basic REST API support, a language switcher block, a language filter for block-based widgets and basic localization for block template parts.
